public class CatHouseRunner {
    public static void main(String[] args) {
        ...
        Cat cat1 = new Cat("Kei",9);
        Cat cat2 = new Cat("Kiyo",11);

        CatHouse catHouse = new CatHouse(cat1, cat2, "Felix");
        ...
        /*Cat cat3 = new Cat("Kei",9);
        Cat cat4 = new Cat("Kei",11);

        CatHouse catHouse2 = new CatHouse(cat3, cat4, "Felix");
        System.out.println(catHouse2.houseInfo());
        catHouse2.rollCall();
        catHouse2.catNoise();*/
